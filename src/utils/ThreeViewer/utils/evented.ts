...
function extend(dest: Object, ...sources: Array<Object>): Object {
...
export class Evented {
    ...
    off(type: string, listener: Listener) {
        _removeEventListener(type, listener, this._listeners as any);
        _removeEventListener(type, listener, this._oneTimeListeners as any);
    ...
    fire(event: Event | string, properties?: Object) {
